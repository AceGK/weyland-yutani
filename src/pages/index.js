      ...
      <div className={styles.overlayData}>
        ...
        >
          ...
          <ul>
            ...
            <li>
              Remote scans of <strong>LV-223</strong>, a Class-3 Engineer-designated system
            </li>
            <li>
        ...
        >
          ...
          <ul>
            ...
            <li>
              <strong>Acheron Colony Initiative:</strong> Proof of concept for rapid industrial colonization
            </li>
            <li>
              <strong>Sea of Tranquility Expansion:</strong> Lunar development for long-term habitation
            </li>
          </ul>
          <p>
            We don&apos;t just adapt to environments. <strong><em>We create them.</em></strong>
          </p>
        </Section>
